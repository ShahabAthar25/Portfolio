  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-16 relative">
        <div className="relative h-[55vh] min-h-[380px] bg-card overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 max-w-6xl mx-auto px-6 pb-10">
            ...
            <h1
              className="font-extrabold leading-[0.88] tracking-tight mt-3 font-display"
              style={{
      ...
      <div className="border-y border-border bg-card">
        <div className="max-w-6xl mx-auto px-6 py-14 grid grid-cols-1 sm:grid-cols-3 gap-0 divide-y sm:divide-y-0 sm:divide-x divide-border">
          {project.metrics.map((m) => (
            <div
              key={m.label}
              className="px-0 sm:px-10 first:pl-0 last:pr-0 py-8 sm:py-0"
            >
              <div
      ...
      <div className="border-t border-border bg-card">
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <p
            className="font-bold leading-tight font-mono"
          ...
          <button className="w-full group text-left">
            <div className="max-w-6xl mx-auto px-6 py-16 flex items-center justify-between">
              <div>
                ...
                <h2
                  className="font-extrabold leading-tight group-hover:text-accent transition-colors duration-200"
                  style={{
              ...
              <ArrowRight className="w-10 h-10 text-foreground group-hover:text-accent group-hover:translate-x-1 transition-all duration-200 flex-shrink-0" />
            </div>
          </button>
        </div>
      </Link>
