      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          <nav className="hidden md:flex items-center gap-7">
            {["work", "about", "contact"].map((s) => (
              <button
                key={s}
                onClick={() => scrollTo(s)}
                className="text-sm uppercase tracking-widest cursor-pointer text-foreground hover:text-foreground
          transition-colors
          font-mono"
              >
                {s}
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs cursor-pointer font-medium text-accent-foreground bg-accent px-3
        py-1.5
        rounded-full"
          >
            <span
