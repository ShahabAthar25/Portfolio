      ...
      {formStatus === "sent" ? (
        <div className="h-full flex flex-col items-start justify-center gap-4 py-12">
          ...
          <button onClick={() => setFormStatus("idle")}
            className="text-xs font-mono text-muted-foreground hover:text-foreground transition-colors mt-2"
          >
            Send another →
          </button>
        </div>
        ...
        <form onSubmit={handleFormSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea rows={5} placeholder="Tell me about the project..." value={formData.message} onChange={(e) =>
              ...
              className="w-full bg-secondary border border-border text-foreground placeholder:text-muted-foreground
