      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-5 items-start">
        ...
        <div className="border border-border overflow-hidden" style={{ background: "#080808" }}>
          ...
          <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-card">
            ...
            <span className="w-2.5 h-2.5 rounded-full shrink-0" style={{ background: "#3a3a3a" }} />
            <span className="w-2.5 h-2.5 rounded-full shrink-0" style={{ background: "#3a3a3a" }} />
            <span className="ml-3 text-xs text-foreground font-mono">
              capabilities.ts
            </span>
          </div>
          ...
          <div className="p-5 overflow-x-auto">
            <div className="font-mono" style={{ minWidth: "340px" }}>
              ...
              <div key={f.key} style={{ background: activeKey===f.key ? "rgba(197,241,53,0.055)" : "transparent" ,
                borderLeft: activeKey===f.key ? "2px solid #C5F135" : "2px solid transparent" ,
                transition: "background 0.18s, border-color 0.18s" , cursor: "default" , }} onMouseEnter={()=>
                setActiveKey(f.key)}
        ...
        <div className="flex flex-col gap-3">
          ...
          <div key={f.key} className="relative overflow-hidden border p-6 flex flex-col gap-3 cursor-default" style={{
            ...
            : "var(--card)" , transition: "border-color 0.18s, background 0.18s" , }} onMouseEnter={()=>
            setActiveKey(f.key)}
            onMouseLeave={() => setActiveKey(null)}
            >
            ...
            <span
              ...
              style={{ color: active ? "var(--accent)" : "var(--foreground)" , opacity: active ? 0.08 : 0.035,
              transition: "opacity 0.25s, color 0.25s" , }}>
              0{i + 1}
            </span>

            <span className="text-xs tabular-nums font-mono" style={{ color: active ? "var(--accent)"
